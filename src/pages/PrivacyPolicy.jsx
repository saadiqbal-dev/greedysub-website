      ...
      <main style={{ paddingBottom: 100 }}>
        <div className="narrow">
          ...
          <LegalSection num="1" title="Who We Are">
            ...
            <p style={{ ...p, marginBottom: 0 }}>For privacy-related questions, contact us at: <a href="mailto:privacy@greedysub.app" style={{ color: 'var(--sky-deep)' }}>privacy@greedysub.app</a></p>
          </LegalSection>
          ...
          <LegalSection num="7" title="Your Rights">
            ...
            <p style={p}>If you are located in the EEA, UK, or Switzerland, you have additional rights under GDPR: access, rectification, erasure ("right to be forgotten"), restriction of processing, data portability, and the right to object. Contact <a href="mailto:privacy@greedysub.app" style={{ color: 'var(--sky-deep)' }}>privacy@greedysub.app</a> to exercise these rights. Our legal basis for processing license validation data is performance of contract (Article 6(1)(b) GDPR).</p>

            <h3 style={h3}>7.3 CCPA (California Residents)</h3>
            <p style={{ ...p, marginBottom: 0 }}>California residents have the right to know what personal information we collect, the right to deletion, the right to opt out of sale (we do not sell personal information), and the right to non-discrimination. Contact <a href="mailto:privacy@greedysub.app" style={{ color: 'var(--sky-deep)' }}>privacy@greedysub.app</a> to submit a request.</p>
          </LegalSection>
          ...
          <LegalSection num="9" title="Children's Privacy">
            <p style={{ ...p, marginBottom: 0 }}>GreedySub is not directed to children under 13 (or 16 in the EEA). We do not knowingly collect personal information from children. If you believe a child has provided us with personal information, contact <a href="mailto:privacy@greedysub.app" style={{ color: 'var(--sky-deep)' }}>privacy@greedysub.app</a> and we will delete it.</p>
          </LegalSection>
          ...
          <LegalSection num="13" title="Contact Us">
            ...
            <Ul items={[
              '<strong>Email:</strong> <a href="mailto:privacy@greedysub.app" style="color:var(--sky-deep)">privacy@greedysub.app</a>',
